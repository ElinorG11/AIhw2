    ...
    def run_game(self):
        while True:
            if self.curr_agent == Turn.MOVE_PLAYER_TURN:
                ...
                time_diff = end - start
                # print( "current average depth (Player): " + str(self.move_player.depth_sums /
                # self.move_player.move_count))
                # print(time_diff)
                ...
                time_diff = end - start
                # print( "current average depth (Comp): " + str(self.index_player.depth_sums /
                # self.index_player.move_count))
